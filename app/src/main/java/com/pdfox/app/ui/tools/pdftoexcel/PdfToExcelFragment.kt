package com.pdfox.app.ui.tools.pdftoexcel
...
@AndroidEntryPoint
class PdfToExcelFragment : BaseToolFragment() {

    private val viewModel: PdfToExcelViewModel by viewModels()
            ...
            viewModel.uiState.collectLatest { state ->
                when (state) {
                    ...
                    is ToolUiState.Error -> {
                        Timber.e(state.exception, "PDF to Excel failed: ${state.message}")
                    }
                }
            }
        }
    ...
    override fun getToolId(): String = "pdf_to_excel"
