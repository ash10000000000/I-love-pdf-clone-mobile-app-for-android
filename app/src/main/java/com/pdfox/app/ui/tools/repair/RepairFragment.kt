...
import com.pdfox.app.databinding.FragmentRepairBinding
...
@AndroidEntryPoint
class RepairFragment : BaseToolFragment() {
            ...
            viewModel.uiState.collectLatest { state ->
                when (state) {
                    ...
                    is ToolUiState.Error -> {
                        Timber.e(state.exception, "Repair failed: ${state.message}")
                    }
                }
            }
        }
