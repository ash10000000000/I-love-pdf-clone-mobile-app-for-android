...
@AndroidEntryPoint
class ExcelToPdfFragment : BaseToolFragment() {

    private val viewModel: ExcelToPdfViewModel by viewModels()
            ...
            viewModel.uiState.collectLatest { state ->
                when (state) {
                    ...
                    is ToolUiState.Error -> {
                        Timber.e(state.exception, "Excel to PDF failed: ${state.message}")
                    }
                }
            }
        }
    ...
    override fun getToolId(): String = "excel_to_pdf"
    override fun getAcceptedMimeType(): String = FileManager.MIME_EXCEL
    override fun isMultiFile(): Boolean = false
    override fun getSupportedFormats(): List<String> = listOf("XLS", "XLSX")
}
