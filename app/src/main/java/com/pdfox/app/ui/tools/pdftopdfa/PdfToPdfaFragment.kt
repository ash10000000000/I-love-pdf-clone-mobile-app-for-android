...
@AndroidEntryPoint
class PdfToPdfaFragment : BaseToolFragment() {

    private val viewModel: PdfToPdfaViewModel by viewModels()
            ...
            viewModel.uiState.collectLatest { state ->
                when (state) {
                    ...
                    is ToolUiState.Error -> {
                        Timber.e(state.exception, "PDF to PDF/A failed: ${state.message}")
                    }
                }
            }
        }
    ...
    override fun getToolId(): String = "pdf_to_pdfa"
